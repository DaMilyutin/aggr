...
namespace ylems
{
    namespace rules
    {
        ...
        // binary operations
        template<typename tag, typename Y, typename L>
        ...
        template<typename tag, typename Y, typename L>
        YieldLink<tag, Y, L const&> meld(Yield<Y, tag>&& y, Link<L, tag> const& l)
        {
        ...
        template<typename tag, typename L1, typename L2>
        LinkLink<L1, L2, tag> meld(Link<L1, tag>&& l1, Link<L2, tag>&& l2)
        {
            return {FWD(l1)._get_(), FWD(l2)._get_()};
        }

        template<typename tag, typename L, typename S>
        ...
        template<typename tag, typename Y, typename S>
        ...
        template<typename tag, typename Y, typename L, typename S>
        ...
        template<typename tag, typename L1, typename L2, typename S>
        ...
        template<typename tag, typename Y, typename L1, typename L2>
...
//template<typename L, typename R> auto OP(ylems::rules::_terminal_<L,tag>&&      l, ylems::rules::_terminal_<R,tag>&&      r) { return ylems::rules::meld<tag>(FWD(l)._get_(), FWD(r)._get_()); } \
//template<typename L, typename R> auto OP(ylems::rules::_terminal_<L,tag> const& l, ylems::rules::_terminal_<R,tag>&&      r) { return ylems::rules::meld<tag>(l._get_(),      FWD(r)._get_()); } \
//template<typename L, typename R> auto OP(ylems::rules::_terminal_<L,tag>&&      l, ylems::rules::_terminal_<R,tag> const& r) { return ylems::rules::meld<tag>(FWD(l)._get_(),      r._get_()); } \
//template<typename L, typename R> auto OP(ylems::rules::_terminal_<L,tag> const& l, ylems::rules::_terminal_<R,tag> const& r) { return ylems::rules::meld<tag>(l._get_(),           r._get_()); }

#define YLEMS_MELD_OPERATION(tag, OP) \
template<typename L, typename R> auto OP(L&&      l, R&&      r) { return ylems::rules::meld<tag>(FWD(l), FWD(r)); } \
template<typename L, typename R> auto OP(L const& l, R&&      r) { return ylems::rules::meld<tag>(l,      FWD(r)); } \
template<typename L, typename R> auto OP(L&&      l, R const& r) { return ylems::rules::meld<tag>(FWD(l),      r); } \
template<typename L, typename R> auto OP(L const& l, R const& r) { return ylems::rules::meld<tag>(l,           r); }