...
namespace plotting
{
    namespace piping
    {
        template<typename T, typename D, typename I>
                                using Iota        = ylems::elements::Iota<T, D, I, terminal>;
        template<typename T>    using Transform   = ylems::elements::Transform<T, terminal>;
        template<typename T>    using TransformOr = ylems::elements::TransformOr<T, terminal>;
        template<typename T>    using Filter      = ylems::elements::Filter<T, terminal>;
        template<typename... T> using ZipYield    = ylems::elements::ZipYield<terminal, T...>;
